        ...
        route: [
          RouteType(
            ...
            route: [
              ...
              RouteType(
                name: stage.Main.route,
                icon: stage.Main.icon,
                label: stage.Main.label,
                page: const stage.Main(),
              ),
              RouteType(
                name: settings.Main.route,
                icon: settings.Main.icon,
                label: settings.Main.label,
                page: const settings.Main(),
              ),
              RouteType(
              ...
              RouteType(
                name: gallery.Main.route,
                icon: gallery.Main.icon,
                label: gallery.Main.label,
                page: const gallery.Main(),
              ),
            ],
          ),
        ],
