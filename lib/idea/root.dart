...
class IdeaSchemeColor {
  ...
  static IdeaSchemeColor darkColor({
...
abstract class IdeaSchemeData {
  static ThemeData theme(TextTheme textTheme, IdeaSchemeColor color) {
